...
// import { insertXinx } from "../../actions";
        ...
        if(auths[s].id==id){
            ...
            obj.login(function(e){
                ...
                obj.getUserInfo( function(e){
                    ...
                    // this.props.dispatch(insertXinx(obj.userInfo));
                    sessionStorage.id=obj.userInfo.headimgurl.split("/")[5];
                    sessionStorage.qqxinxi=obj.userInfo;
